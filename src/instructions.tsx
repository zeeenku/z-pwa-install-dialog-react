...
const shareIcon = `<svg width="1.25rem" height="1.25rem" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
const addIcon = `<svg width="1.25rem" height="1.25rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const installIcon = `<svg width="1.25rem" height="1.25rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const dotsMenu = `<svg width="1.25rem" height="1.25rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const osInstruc  : { [key: string]: string[] } = {
  "mac/windows/linux" : desktopInstruc,
  "android" : androidInstruc,
  "ios" : iosInstruc,
}

export const instrucs : { [key: string]: { [key: string]: string[] } } = {
